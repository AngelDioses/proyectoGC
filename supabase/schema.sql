-- ============================================
-- GC-FISI - Plataforma de Gestión del Conocimiento Académico
-- FISI - UNMSM
-- ============================================
...
-- Eliminar tipos existentes si existen (para poder recrearlos)
...
-- Eliminar políticas RLS (solo si las tablas existen)
DO $$ 
DECLARE
    r RECORD;
BEGIN
...
-- Eliminar tablas existentes si existen (para recrearlas)
