  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Recursos Aprobados</h1>
          <p className="text-gray-600 dark:text-gray-400">Recursos que has aprobado, organizados por curso</p>
        </div>
          ...
          <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <CardContent className="pt-6">
              <div className="text-center py-12">
                ...
                <p className="text-xl text-gray-700 dark:text-gray-300">No hay recursos aprobados</p>
                <p className="text-gray-500 dark:text-gray-500 mt-2">Los recursos que apruebes aparecerán aquí</p>
              </div>
            </CardContent>
          </Card>
        ) : (
            ...
            {courseResources.map(({ course, resources }) => (
              <div key={course.id} className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Link href={`/dashboard/coordinator/resources/${course.id}`}>
                    <Button variant="ghost" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                      Ver estructura completa <ChevronRight className="h-4 w-4 ml-1" />
                    </Button>
                  </Link>
                </div>
